...
namespace Rabbit
{
    ...
    public static class ArmorGames
    {
        ...
        {
            var c = PlayerIO.QuickConnect.SimpleConnect("everybody-edits-su9rn58o40itdbnw69plyw", "guest", "guest").Multiplayer.JoinRoom(string.Empty, null);
            ...
            c.OnMessage += (sender, message) =>
            {
                ...
                {
                    Client = PlayerIOClient.PlayerIO.Connect(
