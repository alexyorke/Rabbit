namespace Rabbit
{
    // From Simon Mourier http://stackoverflow.com/questions/520347/
    using System;
    ...
    internal class InternetStabilityTester
    {
        ...
        /// </returns>
        public static bool IsNetworkAvailable(long minimumSpeed = 1000)
        {
            ...
            foreach (NetworkInterface ni in NetworkInterface.GetAllNetworkInterfaces())
            {
                ...
                if ((ni.Description.IndexOf("virtual", StringComparison.OrdinalIgnoreCase) >= 0) || (ni.Name.IndexOf(
                    "virtual",
